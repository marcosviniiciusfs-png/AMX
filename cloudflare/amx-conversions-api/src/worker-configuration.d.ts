/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/amx-conversions-api/wrangler.jsonc cloudflare/amx-conversions-api/src/worker-configuration.d.ts` (hash: 1e17d6a5d34a1fd519fff50fe31db363)
// Runtime types generated with workerd@1.20260721.1 2026-07-21 
interface __BaseEnv_Env {
	META_PIXEL_ID: "2032284170758655";
	META_GRAPH_API_VERSION: "v25.0";
	ALLOWED_ORIGINS: "https://amx.simulead.com.br,http://127.0.0.1:8080,http://localhost:8080";
